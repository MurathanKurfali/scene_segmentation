...
python -m allennlp predict  "${model}" "${test_file}" --output-file "${output_file}" --use-dataset-reader --predictor SeqClassificationPredictor --include-package code.sequential_sentence_classification --cuda-device 0
